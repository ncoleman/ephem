...
function ts_sort_date(a,b) {
	...
	//  NJC 09/15/2010 BEWARE this sorts on American dates (I think)
...
function ts_sort_time(a,b) {
	// NJC 09/15/2010 created this for my ephem table so I can sort on the time that is displayed in the table.
	//  relies on times being in 24 hr clock format
	aa = ts_getInnerText(a.cells[SORT_COLUMN_INDEX]);
	bb = ts_getInnerText(b.cells[SORT_COLUMN_INDEX]);
